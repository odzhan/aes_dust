...
//
// Define DYNAMIC to use a function or generate the table at runtime.
// Generating table at runtime works, but is mainly provided as a reference.
//
#ifndef DYNAMIC

#ifdef RUNTIME
static u8 sbox[256] = { 0 };
...
#endif
#else
  // SubByte as a function. Very slow!
static
u8 
S(u8 x) {
    u8 i, y, c;
