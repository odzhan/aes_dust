...
## Highlights
- AES-128 with ECB, CBC, CTR, OFB, and GCM modes.
...
The script prefers CMake presets when available and falls back to a classic configure/build flow. CTest is optional; when it is absent tests are skipped.
...
|------|-------------|--------|
| ECB  | Electronic Codebook | Available |
| CBC  | Cipher Block Chaining | Available |
| OFB  | Output Feedback | Available |
| CTR  | Counter | Available |
| GCM  | Galois/Counter Mode | Available |
| CFB  | Cipher Feedback | Not implemented |
